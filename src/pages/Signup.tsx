...
const benefits = [
  "Accedi a contenuti esclusivi per i membri",
  "Sincronizza con Discord per ruoli speciali",
  "Ottieni accesso anticipato ai nuovi video",
  "Sconti e premi nello shop",
];
...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Registrazione completata con successo. Ora puoi effettuare il login.",
      });

      navigate("/login");
    } catch (error: any) {
      let errorMessage = "Impossibile creare l'account";
      ...
      if (error.message?.includes("User already registered") || error.message?.includes("already registered")) {
        ...
        errorMessage = "Email non valida. Controlla l'indirizzo inserito.";
  ...
  const handleOAuthSignup = async (provider: 'google' | 'discord') => {
    ...
    try {
      ...
      toast({
        title: "Errore",
        description: error.message || `Impossibile registrarsi con ${provider === 'google' ? 'Google' : 'Discord'}`,
        variant: "destructive",
      });
  ...
  return (
    <Layout>
      <section className="pt-32 pb-24 relative min-h-screen flex items-center">
        <GlowOrb size="lg" className="top-20 left-0 -translate-x-1/2" />
        <GlowOrb size="md" color="amber" className="bottom-20 right-0 translate-x-1/2" />
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden md:block">
                <h2 className="font-display text-3xl font-bold mb-6">
                  Unisciti alla Comunità <span className="gradient-text">LegoChris</span>
                </h2>
                <p className="text-muted-foreground mb-8">
                  Crea il tuo account gratuito e sblocca un mondo di contenuti esclusivi, 
                  funzionalità della comunità e vantaggi per i membri.
                </p>
              ...
              <div>
                <div className="text-center md:text-left mb-8">
                  <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">
                    Crea <span className="gradient-text">Account</span>
                  </h1>
                  <p className="text-muted-foreground">
                    Inizia oggi il tuo viaggio nel mondo di Mario
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Deve essere di almeno 6 caratteri</p>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <Label htmlFor="newsletter" className="text-sm text-muted-foreground font-normal cursor-pointer">
                      Voglio ricevere la newsletter con aggiornamenti, eventi e offerte speciali
                    </Label>
                  </div>
